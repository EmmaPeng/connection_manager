...
u_char *ngx_module_names[] = {
    ...
    (u_char *) "ngx_tcp_module",
    (u_char *) "ngx_tcp_core_module",
    (u_char *) "ngx_tcp_upstream_module",
    (u_char *) "ngx_xmpp_proxy_module",
    (u_char *) "ngx_tcp_upstream_check_status_module",
    NULL
};
