...
*/
	u_char *data = ngx_pcalloc(c->pool,XML_CM2S_CLOSE_LEN + s->channel_id.len);
	sprintf((char*)data,XML_CM2S_CLOSE,ctx->xml_tofrom.data,s->channel_id.data,s->channel_id.data);
