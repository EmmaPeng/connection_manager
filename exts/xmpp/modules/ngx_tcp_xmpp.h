...
#define XML_CM2C_FEATURES "<stream:stream xmlns:stream=\"http://etherx.jabber.org/streams\" xmlns=\"jabber:client\" from=\"etop.com\" id=\"%s\" xml:lang=\"en\" version=\"1.0\"><stream:features><mechanisms xmlns=\"urn:ietf:params:xml:ns:xmpp-sasl\"><mechanism>AASAUTH</mechanism></mechanisms><compression xmlns=\"http://jabber.org/features/compress\"><method>zlib</method></compression><auth xmlns=\"http://jabber.org/features/iq-auth\" /><register xmlns=\"http://jabber.org/features/iq-register\" /></stream:features>"
#define XML_CM2C_FEATURES_LEN strlen(XML_CM2C_FEATURES)

extern ngx_module_t  ngx_tcp_xmpp_proxy_module;
